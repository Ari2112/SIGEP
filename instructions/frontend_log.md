According to a document from **2025** (casos de uso del prototipo de RRHH para  *Alquileres Segura* ), aquí tienes el **desglose del proyecto en módulos** con **historias de usuario** (tipo Scrum) y  **criterios de aceptación** .
